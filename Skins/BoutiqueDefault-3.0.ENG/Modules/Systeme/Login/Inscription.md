...
<!--	<div class="form-group [IF [!I_Societe_Error!]]error[/IF]">
		<label class="col-sm-6 control-label" for="I_Societe">Nom Societe </label>
		<div class="col-sm-6">
			<input type="text" class="form-control"  name="I_Societe" value="[IF [!Reset!]=][!I_Societe!][/IF]" tabindex="50" />
		</div>
	</div>
	<div class="form-group [IF [!I_Siret_Error!]]error[/IF]">
		<label class="col-sm-6 control-label" for="I_Siret">N° Siret </label>
		<div class="col-sm-6">
			<input type="text" class="form-control"  name="I_Siret" value="[IF [!Reset!]=][!I_Siret!][/IF]" style="text-transform:uppercase;"  tabindex="60" />
		</div>
	</div>
-->
	...
	<div class="form-group [IF [!I_Portable_Error!]]error[/IF]">
		...
		<div class="col-sm-6">
			<input type="text" class="form-control"  name="I_Portable" value="[IF [!Reset!]=][!I_Portable!][/IF]" tabindex="140" />
		</div>
	</div>
	...
	<div class="form-group [IF [!C_Code_Error!]]error[/IF]">
		...
		<div class="col-sm-6">
			...
			<div class="pull-left"><input type="text" class="form-control" tabindex="190" name="Result" value="[!Result!]" size="5" class="Op" style="margin-left:5px;"[IF [!C_Calc_Error!]] class="Error" [/IF] /></div>
