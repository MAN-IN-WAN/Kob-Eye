...
jQuery(document).ready(function($){
    ...
    $('#optionDemande1').change(function(event){
        event.preventDefault();
        $("#formTopSyndic").css('display','block');
        $("#formTopGestion").css('display','none');
        $("#formTopSaisoniere").css('display','none');
        $("#formTopVente").css('display','none');
    });
    $('#optionDemande2').change(function(event){
        event.preventDefault();
        $("#formTopSyndic").css('display','none');
        $("#formTopSaisoniere").css('display','none');
        $("#formTopGestion").css('display','block');
        $("#formTopVente").css('display','none');
    });
    $('#optionDemande3').change(function(event){
        event.preventDefault();
        $("#formTopSyndic").css('display','none');
        $("#formTopSaisoniere").css('display','none');
        $("#formTopGestion").css('display','none');
        $("#formTopVente").css('display','block');
    });
    $('#optionDemande4').change(function(event){
        event.preventDefault();
        $("#formTopSyndic").css('display','none');
        $("#formTopGestion").css('display','none');
        $("#formTopVente").css('display','none');
        $("#formTopSaisoniere").css('display','block');
    });


    $(".submitFormDevis").click(function(){
        $.ajax({
            type: "POST",
            url: 'Systeme/User/sendDevisMail.json',
            data: $("#formDevis").serialize(),
    ...
    $("#submitFormContact").click(function(){
        $.ajax({
            type: "POST",
            url: 'Systeme/User/sendContactMail.json',
