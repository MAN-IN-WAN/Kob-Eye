...
<div class="BlocFichContent" >
	<div class="BlocFichPrix">
		...
		<span class="badge badge-warning pull-right price" id="tarif">[!Math::PriceV([!Prod::getTarif!])!][!CurrentDevise::Sigle!]</span>
		[IF [!Promo!]!=0]
		...
		[/IF]
		<h1>[!Prod::Nom!]</h1>
		<blockquote>[!Prod::Accroche!]</blockquote>
	</div>
	...
	function VerifieSelection () {
		...
		var r = new Request.JSON({
			...
			onSuccess: function (json,text){
				...
				else $('tarifNonPromo').setStyle('display', 'none');
