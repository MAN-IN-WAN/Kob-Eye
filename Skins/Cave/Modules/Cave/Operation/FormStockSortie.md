{"form":{"type":"TitleWindow","id":"FormStockSortie","title":"SORTIE DE STOCK",
...
"components":[
	{"type":"VBox","percentWidth":100,"percentHeight":100,"minWidth":570,"setStyle":{"paddingLeft":5,"paddingRight":5,"paddingTop":5,"paddingBottom":5},
	...
	"components":[
		...
		"components":[
			...
			"components":[
				...
				{"type":"DataField","dataField":"SousTypeId","defaultValue":2},
				...
				{"type":"FormItem","labelWidth":80,"label":"Origine","percentWidth":100,"components":[
					{"type":"HGroup","gap":2,"components":[
						...
						"exoFields":{"Cuve":"Cuve","Volume":"Contenu","Capacite":"Capacite","CuveLotId":"LotId","Lot":"Lot","Categorie":"Categorie","Couleur":"Couleur"}},
				...
				{"type":"FormItem","label":"Client","labelWidth":80,"components":[
					{"type":"HGroup","gap":2,"components":[
						...
						"kobeyeClass":{"module":"Cave","objectClass":"Tiers","setFilter":"TypeTiersId=2","form":"PopupList.json"},
