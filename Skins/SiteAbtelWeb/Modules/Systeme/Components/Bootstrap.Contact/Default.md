...
[IF [!SendContact!]=||[!C_Error!]]
	<div id="contactContainer" class="row">
		<div id="contactMap" class="col-md-4">
			[!Groupe::Map!]
		</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="control-group row last [IF [!C_Calc_Error!]]error[/IF]">
								<label class="control-label col-md-6" for="C_Nom">Merci de résoudre l'opération suivante avant de valider <span class="Obligatoire">*</span></label>
