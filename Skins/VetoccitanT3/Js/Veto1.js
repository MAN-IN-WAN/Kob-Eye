...
$( document ).ready(function() {
    ...
    $('.menuLink a').on('click',function(event){
        ...
        $('#SiteVeto2').removeClass("page_accueil");
        $('#SiteVeto2').addClass('page_'+(tempAlias != ""?tempAlias:"accueil"));
...
window.onload = function() {
    ...
    $('#Main').css('paddingLeft',( getScrollBarWidth() + 15 )+ 'px');
    $('#MenuBar').css('paddingLeft',( getScrollBarWidth() + 15 )+ 'px');
    $('#MenuBar').css('paddingRight',( getScrollBarWidth() + 15 )+ 'px');
}
