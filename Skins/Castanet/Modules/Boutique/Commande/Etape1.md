					...
					[STORPROC [!Panier::LignesCommandes!]|Pan]
						...
						<tr class="ReferenceLine" data-ref="[!Pan::Reference!]" data-conf="[!Pan::Config!]">
							...
							<td >
								...
								<div class="BoutonMoins"><input type="button" class="button btn-protector" value="-" onclick="CalculQte(-[!NbUnite!],[!Pan::Quantite!],'[!refObj::Reference!]');" /></div>
								[/IF]
								...
								[IF [!Pan::TypeProduit!]<4]
								<div class="BoutonPlus"><input type="button" class="button btn-protector"  value="+" onclick="CalculQte([!NbUnite!],[!Pan::Quantite!],'[!refObj::Reference!]');"></div>
								[/IF]
							</td>
...
<!--			<div class="row LigneBoutons"><div class="col-md-12">
			...
			<div class="row LigneBoutons"><div class="col-md-12">
				<div class="pull-right">
					<input class="button btn-success" type="submit" name="Valider" value="Je valide ma commande" />
				</div>
				<div class="pull-right" style="margin-bottom:30px;">
					<input class="button btn-protector" type="submit" name="Continue" value="Continuer mes achats" />
				</div>
			</div>
		</form>
