...
textures = [
    { name: 'white cloud', 	file: '/Skins/Eng.Systems/Img/cloud.png'		, opacity: 1, weight: 0 },
    { name: 'dark cloud', 	file: '/Skins/Eng.Systems/Img/darkCloud.png'	, opacity: 1, weight: 0 },
    { name: 'smoke cloud', 	file: '/Skins/Eng.Systems/Img/smoke.png'		, opacity: 1, weight: 0 },
    { name: 'explosion', 	file: '/Skins/Eng.Systems/Img/explosion.png'	, opacity: 1, weight: 0 },
    { name: 'explosion 2', 	file: '/Skins/Eng.Systems/Img/explosion2.png'	, opacity: 1, weight: 0 }
];
