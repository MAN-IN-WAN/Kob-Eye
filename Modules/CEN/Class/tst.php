...
//------- Teste_96_
if($col15 != "***") {
	if(strpos($t70[$ii][6], "v.i.") !== false && $t70[$ii][2] == "r.v." && $nb_passif == 0 && strpos($t70[$ii + 1][2], "suf. adj.") === false) {
...
//------- Teste_97_
if($col15 != "***") {
	if(strpos($t70[$ii][6], "v.t.") !== false && $t70[$ii][2] == "r.v." && $nb_passif == 0 && strpos($t70[$ii + 1][2], "suf. adj.") === false) {
		switch($nb_causatif_applicatif) {
			case 0:
				switch($nb_tot_objet) {
					case 0:
...
//------- Teste_98_
if($col15 != "***") {
	if(strpos($t70[$ii][6], "v.bi.") !== false && $t70[$ii][2] == "r.v." && $nb_passif == 0 && strpos($t70[$ii + 1][2], "suf. adj.") === false) {
		switch($nb_tot_objet) {
			case 0:
...
//------- Teste_36
if($col15 != "***") {
	if($t70[$ii][2] == "suf. loc. (can)" && $nb_objet == 0 && $nb_r_nominale == 0 && strpos($t70[$ii - 1][6], "v.i.") === false && strpos($t70[$ii - 1][2], "adj.") === false && strpos($t70[$ii - 1][2], "adv.") === false) {
		$col15 = "***";
		$test_fait = 1;
	}
}
...
//------- Teste_50
if($col15 != "***") {
	if($t70[$ii][2] == "liga." && strpos($t70[$ii + 1][6], "aux.") === false) {
		$col15 = "***";
		$test_fait = 1;
	}
}
...
//------- Teste_53
if($col15 != "***") {
	if(strpos($t70[$ii][6], "aux.") !== false && $t70[$ii][3] == "uh" && $t70[$ii - 1][2] != "liga.") {
		$col15 = "***";
		$test_fait = 1;
	}
}
...
//------- Teste_58
if($col15 != "***") {
	if(strpos($t70[$ii][6], "aux.") !== false && strpos($t70[$ii][6], "v.t.") === false && strpos($t70[$ii][6], "v.i.") === false && strpos($t70[$ii - 1][4], "r.n.") !== false) {
		$col15 = "***";
		$test_fait = 1;
	}
}
...
//------- Teste_72
if($col15 != "***") {
	if(strpos($t70[$ii][6], "v.r.") === false && $t70[$ii][2] == "r.v." && $nb_reflechi > 0) {
		$col15 = $col15 + " non v.r.";
		$l5[5] = "ibleuclair";
		$test_fait = 1;
	}
...
//------- Teste_74
if($col15 != "***") {
	if($t70[$ii][6] == "_v.r._" && $t70[$ii][2] == "r.v." && $nb_reflechi == 0 && $nb_passif == 0) {
		$col15 = "***";
		$test_fait = 1;
	}
}
