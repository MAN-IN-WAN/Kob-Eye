...
class NoteProduit extends genericClass {
	...
	public function Save() {
		...
		// Calcul moyenne
		$total = 0;
		$prod = $GLOBALS['Systeme']->Modules['Boutique']->callData('Produit/NoteProduit/' . $this->Id);
		$evals = $GLOBALS['Systeme']->Modules['Boutique']->callData('Produit/'.$prod[0]['Id'].'/NoteProduit');
