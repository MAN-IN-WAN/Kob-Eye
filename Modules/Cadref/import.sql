...
insert into kbabtel.`kob-Cadref-Annee` (Annee,EnCours) values ('2017',1);
...
left join kbabtel.`kob-Cadref-Classe` c on c.CodeClasse=e.Delegue
...
select 7,7,7,r.Numero,'2017',unix_timestamp(r.DateRegl),Somme,`Mode`,r.Notes,Differe,Encaisse,Supprime,Utilisateur,a.Id
...
insert into kbabtel.`kob-Cadref-Visite` (umod,gmod,omod,Visite,Libelle,Annee,DateHeure,Places,Inscrits,Attentes,Prix1,Prix2,Prix3)
