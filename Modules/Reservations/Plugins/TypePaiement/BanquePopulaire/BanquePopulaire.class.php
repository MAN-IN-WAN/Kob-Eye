...
class ReservationsTypePaiementBanquePopulaire extends Plugin implements ReservationsTypePaiementPlugin {
	...
	public function getCodeHTML( $paiement ) {
		...
		$(\'PaiementForm\').addEvent(\'submit\', function(e) {
			...
			var r = new Request.JSON({
				url: "/Reservations/Paiement/setPending.json?Paiement=" + '.$paiement->Id.',
