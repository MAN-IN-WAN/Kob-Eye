...
class ReservationsTypePaiementPayPlug extends Plugin implements ReservationsTypePaiementPlugin {
	...
	*/
	...
	public function getCodeHTML( $paiement ) {
		...
		$paymentUrl = PaymentUrl::generateUrl(array(
			 ...
			 'ipnUrl' => "http://".$_SERVER['HTTP_HOST']."/Reservations/Facture/IPN",
			 'cancelUrl' => "http://".$_SERVER['HTTP_HOST']."/Reservations/Facture/".$fact->Id."/Annulation",
			 'returnUrl' => "http://".$_SERVER['HTTP_HOST']."/Reservations/Facture/".$fact->Id."/Confirmation",
