<form action="" method="post" name="rech" class="FormRech">
	<div id="Arbo">
		[BLOC Panneau]
				[BLOC Rounded|background-color:#9A9EA0;color:#FFFFFF;|margin-bottom:5px;]
					Importation dossier
				[/BLOC]
				S&eacute;lectionnez un ou plusieurs dossier contenant directement des images ainf de les importer dans cette cat&eacute;gorie du module galerie.
	...
	<div id="Data">
		...
		[BLOC Panneau]
			[IF [!TYarggla!]=Importer]
				...
				[STORPROC [!Doss!]|D]
					...
					[STORPROC Explorateur/Dossier/Home/Galerie/[!D!]/Fichier|F]
						...
						[METHOD Im|Set][PARAM]Fichier[/PARAM][PARAM]Home/Galerie/[!D!]/[!F::Nom!][/PARAM][/METHOD]
						[METHOD Im|AddParent][PARAM]Galerie/Portfolio/[!C::Id!][/PARAM][/METHOD]
			...
			[ELSE]
				[BLOC Rounded|background-color:#9A9EA0;color:#FFFFFF;|margin-bottom:5px;]Importation dossier, contenu de Home/Galerie.
				[/BLOC]
				<div style="overflow:auto;position:absolute;top:30px;bottom:30px;width:100%;background-color:white;">
				<ul>
