...
class BoutiqueTypePaiementAtos extends Plugin implements BoutiqueTypePaiementPlugin {
	...
	*/
	...
	public function __construct() {
		if (!defined("ATOS_LIB_DIR"))define("ATOS_LIB_DIR", dirname(dirname(dirname(dirname(dirname(dirname(__FILE__))))))."/Class/Lib/Atos");
	}
	...
	private function generateTransactionFile( $id ) {
		...
		$str .= "HEADER_FLAG!yes!\r\n";
		$str .= "LANGUAGE!fr!\r\n";
		$str .= "LOGO!LovePaper.jpg!\r\n";
		$str .= "LOGO2!LovePaper.jpg!\r\n";
	...
	public function getCodeHTML( $paiement ) {
		...
		***************************************************/
		...
		$command .= " language=fr";
// pour test désactivation 3D secure
   		$command .= " data=" . '3D_BYPASS' ;
