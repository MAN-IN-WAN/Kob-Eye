...
class BoutiqueTypePaiementPayBox extends Plugin implements BoutiqueTypePaiementPlugin {
	...
	*/
	...
	public function getCodeHTML( $paiement ) {
		...
		//informations nécessaires aux traitements (réponse)
		     ...
		     $PBX_EFFECTUE    = "http://".$_SERVER['HTTP_HOST']."/".Sys::getMenu('Boutique/Commande/Etape5');
		     $PBX_REFUSE      = "http://".$_SERVER['HTTP_HOST']."/".Sys::getMenu('Boutique/Commande/Etape5');
		     $PBX_ANNULE      = "http://".$_SERVER['HTTP_HOST']."/".Sys::getMenu('Boutique/Commande/Etape5');
		     $PBX_REPONDRE_A  = "http://".$_SERVER['HTTP_HOST']."/".Sys::getMenu('Boutique/Commande/Etape4s');
		//page en cas d'erreur
		     $PBX_ERREUR      = "http://".$_SERVER['HTTP_HOST']."/".Sys::getMenu('Boutique/Commande/Etape5');
		//date
		     $PBX_TIME	      =  date("c");
