  ...
  var $Panier;
	...
	*/
	function makeUser() {
		...
		$Utilisateur->AddParent("Systeme/Group/".TENNISFOREVER_CLIENT_GROUP);
		return $Utilisateur;
	}
...
// ajout du pass à la modification et du coup on se reconnecte à chaque modification du user
	...
	*/
	...
	function  EnvoiEmailConfirmation() {
		...
		$bloc = new Bloc();
		$mailContent = "
			Bonjour " . $this->Civilite . " ".$this->Nom." ".$this->Prenom.",<br />Veuillez confirmer votre adresse email et activer votre compte en cliquant sur le lien ci-dessous: <br/><a href='http://reservation.tennisforever.fr/TennisForever/Client/ConfirmEmail?code=".$user->CodeVerif."'>Confirmer votre adresse maintenant</a>";
