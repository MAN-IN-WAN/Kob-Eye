...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/_classHTML2PDF/exception.class.php');
    require_once(dirname(__FILE__).'/_classHTML2PDF/locale.class.php');
    require_once(dirname(__FILE__).'/_classHTML2PDF/myPdf.class.php');
    require_once(dirname(__FILE__).'/_classHTML2PDF/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/_classHTML2PDF/parsingCss.class.php');
...
'.$content.'
        ...
        protected function _setMargins()
        {
            ...
            $this->pdf->SetAutoPageBreak(true, $this->_margeBottom);
