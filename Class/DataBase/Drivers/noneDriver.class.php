<?php
class noneDriver extends ObjectClass{
	...
	function insertObject($Properties,$Update){
            
		/*echo "=> INSERT OBJECT<br />\r\n";*/
                $Properties["Id"] = rand(1,1000);
                $Properties["tmsCreate"] = $Properties["tmsEdit"] = $Properties["LogTimeStamp"];
                return $Properties;
	}
