...
class ldapDriver extends ObjectClass {
	...
	function Search($Recherche='',$Analyse="",$get=false,$parent=false,$Key="",$Select="",$DataSource="",$filtre=""){
		echo "//////////////////////////////////////////////////////////////////////////////////\r\n";
		...
		$search_id = ldap_search($GLOBALS["Systeme"]->Db[$this->Bdd], $GLOBALS["Systeme"]->Modules[$this->Module]->Bdd[$this->Bdd]["BASE_DN"], $f); 
		$result_array = ldap_get_entries($GLOBALS["Systeme"]->Db[$this->Bdd], $search_id); 
